...
const imgMiddle = 'C:/Users/vivPR/.gemini/antigravity/brain/9afb9fd9-3f7d-4d23-9c77-091fbc3ca5d8/master_booth_middle_32k_1787490865631.jpg';
const imgLeft   = 'C:/Users/vivPR/.gemini/antigravity/brain/9afb9fd9-3f7d-4d23-9c77-091fbc3ca5d8/master_booth_left_32k_1787490958725.jpg';
const imgRight  = 'C:/Users/vivPR/.gemini/antigravity/brain/9afb9fd9-3f7d-4d23-9c77-091fbc3ca5d8/master_booth_right_32k_1787491051254.jpg';
...
(async () => {
  ...
  const nodes = [
    { id: 0, name: '01. 부스 메인 중앙 전경 (Middle Master)', path: imgMiddle },
    { id: 1, name: '02. 부스 좌측 전경 (Left Master)',         path: imgLeft },
    { id: 2, name: '03. 부스 우측 전경 (Right Master)',        path: imgRight }
  ];

  for (const node of nodes) {
    console.log(`Processing Master 32K Remaster: ${node.name}...`);
    ...
    await page.setContent(`
      ...
      <script>
        ...
        img.onload = () => {
          ...
          bgGrad.addColorStop(0.0, '#04070d');
          bgGrad.addColorStop(0.18, '#08101c');
          bgGrad.addColorStop(0.40, '#0c1524');
          bgGrad.addColorStop(0.60, '#0c1524');
          bgGrad.addColorStop(0.82, '#08101c');
          bgGrad.addColorStop(1.0, '#03060a');
          ...
          const topFeather = ctx.createLinearGradient(0, targetY, 0, targetY + 180);
          topFeather.addColorStop(0, 'rgba(4, 7, 13, 0.95)');
          topFeather.addColorStop(1, 'rgba(4, 7, 13, 0)');
          ctx.fillStyle = topFeather;
          ctx.fillRect(0, targetY - 10, 8192, 200);

          const btmFeather = ctx.createLinearGradient(0, targetY + targetH - 180, 0, targetY + targetH);
          btmFeather.addColorStop(0, 'rgba(3, 6, 10, 0)');
          btmFeather.addColorStop(1, 'rgba(3, 6, 10, 0.95)');
          ctx.fillStyle = btmFeather;
          ctx.fillRect(0, targetY + targetH - 180, 8192, 200);
  ...
  await browser.close();
  console.log('All Master 32K Remasters processed successfully!');
  process.exit(0);
})();
