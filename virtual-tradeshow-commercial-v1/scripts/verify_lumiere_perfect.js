...
async function run() {
  ...
  console.log('Lumiere 100% 매칭 쇼룸 접속...');
  await page.goto(`${BASE_URL}/demo-cosmetic.html`, { waitUntil: 'networkidle2' });
  await new Promise(r => setTimeout(r, 2000));
  await page.screenshot({ path: path.join(OUT_DIR, 'LUMIERE_PERFECT_MATCH_ALL_4_PRODUCTS.png') });
  console.log('📸 LUMIERE_PERFECT_MATCH_ALL_4_PRODUCTS.png 저장');
