...
(async () => {
  ...
  // (A) 헤더 스크린샷
  await page.screenshot({ path: 'C:/Users/vivPR/.gemini/antigravity/brain/9afb9fd9-3f7d-4d23-9c77-091fbc3ca5d8/PROD_LIVE_HEADER_20PX.png', fullPage: false });
  ...
  await page.screenshot({ path: 'C:/Users/vivPR/.gemini/antigravity/brain/9afb9fd9-3f7d-4d23-9c77-091fbc3ca5d8/PROD_LIVE_VFR_PLAYING.png', fullPage: false });
  ...
  await new Promise(r => setTimeout(r, 1200));
  await page.screenshot({ path: 'C:/Users/vivPR/.gemini/antigravity/brain/9afb9fd9-3f7d-4d23-9c77-091fbc3ca5d8/PROD_LIVE_VMA_PLAYING.png', fullPage: false });

  await browser.close();
  console.log('✅ ALL LIVE PRODUCTION MEDIA & SCREENSHOTS VERIFIED SUCCESS!');
})();
