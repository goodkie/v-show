...
public class UltraUpscaler {
    public static void ProcessShowroom(string sourcePattern, string dest8k, string dest16k, string destPreview, int targetW, int targetH) {
        ...
        using (Bitmap src = (Bitmap)Image.FromFile(sourceFile)) {
            int srcW = src.Width;
            int srcH = src.Height;
            Console.WriteLine("Source dimension: " + srcW + "x" + srcH);

            // 1. High Quality 8K Canvas (8192 x 4096)
            ...
            using (Graphics g = Graphics.FromImage(dest)) {
                ...
                // Main view rectangle: preserve aspect ratio and maximize sharpness
                int drawW = (int)(targetW * 0.90);
                ...
                // Left & Right edge continuation for smooth 360 wrap
                int edgeW = 120;
                ...
                // Top & Bottom ceiling/floor smooth expansion
                ...
                // Draw central ultra-crisp hero area
                ...
                if (!string.IsNullOrEmpty(dest16k)) {
                    ...
                    Console.WriteLine("✅ Copied 16K: " + dest16k);
                }
                ...
                if (!string.IsNullOrEmpty(destPreview)) {
                    ...
                    using (Graphics gP = Graphics.FromImage(prev)) {
                        ...
                        Console.WriteLine("✅ Saved Preview: " + destPreview);
                    }
                }
            }
        }
    ...
    public static void Main() {
        ...
        Console.WriteLine("\n🎉 All 3 Showroom 8K Panoramas generated with maximum fidelity!");
    }
}
