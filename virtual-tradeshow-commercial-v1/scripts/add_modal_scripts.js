...
function openConsultationModal(serviceName = 'AI Virtual Fitting Room') {
...
// 스크립트 추가
if (!html.includes('function openConsultationModal')) {
  html = html.replace('</script>', `${modalScript}\n</script>`);
}
...
console.log('✅ Added robust openConsultationModal, closeConsultationModal, and handleConsultationSubmit functions!');
