...
(async () => {
  ...
  // 1. 랜딩 페이지 스크린샷
  await page.goto('https://v-show-commercial-v1-production.up.railway.app/', { waitUntil: 'load', timeout: 20000 });
  ...
  // 2. builder.html 스크린샷
  await page.goto('https://v-show-commercial-v1-production.up.railway.app/builder.html', { waitUntil: 'load', timeout: 20000 });
  await new Promise(r => setTimeout(r, 1500));
