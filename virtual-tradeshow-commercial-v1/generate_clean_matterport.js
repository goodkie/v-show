// generate_clean_matterport.js — Matterport 64K Ultra-HD Master Studio (v8.0)
// Features:
// 1. 4 Industrial Robot Products (Apex Cobot X16, Vector AMR 600, Titan Delta D12, Hyperion SCARA S8)
// 2. 2/3 Height 3D Player + Bottom 4-Product Shortcut Cards Bar
// 3. Permanent 3D Floating Capsules with Live Mini-Thumbnails & English Titles
// 4. Unified Right Sidebar (Spatial Vantage Points removed, Booth Radar & Focused Specs preserved)
// 5. Product Drawer Media Mode: 4K Photo + Interactive 360° 3D Mini Player with OrbitControls & Procedural Robotics
// 6. 100% Full English Localization throughout entire interface
const fs = require('fs');
...
/* ══════════════════════════════════════════════
   RIGHT UNIFIED SIDEBAR (Radar + Equipment Specs)
══════════════════════════════════════════════ */
.unified-sidebar {
...
<div id="app-layout">
  ...
  <header id="topbar">
    ...
    <div class="top-actions">
      ...
      <button class="btn-ui download" onclick="openDownloadModal()">📥 64K DOWNLOAD</button>
  ...
  <div id="portrait-tip-bar" onclick="this.style.display='none'">
    📱 Rotate your phone to <strong>[Landscape Mode]</strong> for the optimal ultra-wide 64K studio experience!
  ...
  <main id="studio-workspace">
    ...
    <section id="player-workspace">
      <div id="viewer-container">
        ...
        <div class="player-tag">🌐 64K Master Ultra-HD 360° Tour</div>
    ...
    <!-- RIGHT UNIFIED SIDEBAR (Booth Radar & Focused Equipment Specs) -->
    <aside class="unified-sidebar">
      ...
      <div class="spec-panel-box">
        ...
        <div class="spec-desc" id="side-spec-desc">6-axis precision collaborative robot with integrated joint torque sensors and ISO/TS 15066 safety certification.</div>
  ...
  <footer id="studio-footer">
    <div class="foot-info">
      <span>Engine: <strong>Three.js WebGL 64K Master</strong></span>
      <span>Filtering: <strong>16x Anisotropic + ACES Filmic HDR</strong></span>
      <span>Vantage: <strong id="foot-loc">01. Main Booth Center</strong></span>
    </div>
...
<div class="app-modal" id="download-modal" onclick="if(event.target===this)closeDownloadModal()">
  <div class="modal-box">
    ...
    <h2 style="font-size:17px;font-weight:800;color:#fff;margin:6px 0 6px;">📸 64K Master Ultra-HD Download</h2>
    <p style="font-size:11px;color:var(--text-muted);line-height:1.5;margin-bottom:14px;">
      Direct download links for 64K (65,536 × 32,768) uncompressed equirectangular panorama master photography assets.
    </p>

    <div class="dl-card">
      <div class="dl-info">
        <div class="dl-title">01. Main Booth Central Panorama (Middle Master)</div>
        <div class="dl-meta">Ultra-HD Equirectangular JPG (64K Master) · 3.7 MB</div>
      </div>
      <a href="/assets/demo/dna-showcase/pano360/node0_360_panorama_8k.jpg" download="DN_a_Booth_Main_64K.jpg" class="dl-btn">⬇ Download</a>
    </div>

    <div class="dl-card">
      <div class="dl-info">
        <div class="dl-title">02. Cobot Workstation Area (Left Master)</div>
        <div class="dl-meta">Ultra-HD Equirectangular JPG (64K Master) · 3.5 MB</div>
      </div>
      <a href="/assets/demo/dna-showcase/pano360/node1_360_panorama_8k.jpg" download="DN_a_Cobot_Station_64K.jpg" class="dl-btn">⬇ Download</a>
    </div>

    <div class="dl-card">
      <div class="dl-info">
        <div class="dl-title">03. AMR & Media Cell Area (Right Master)</div>
        <div class="dl-meta">Ultra-HD Equirectangular JPG (64K Master) · 4.0 MB</div>
      </div>
      <a href="/assets/demo/dna-showcase/pano360/node2_360_panorama_8k.jpg" download="DN_a_AMR_Cell_64K.jpg" class="dl-btn">⬇ Download</a>
    </div>

    <div style="display:flex;gap:10px;margin-top:14px;">
      <button class="btn-ui primary" style="flex:1;justify-content:center;padding:10px;" onclick="downloadAllPhotos()">📦 Download All 3 Master Views</button>
      <button class="btn-ui" style="padding:10px;" onclick="closeDownloadModal()">Close</button>
    </div>
  </div>
</div>
...
<script>
/* ═══════════════════════════════════════════════════════════
   MATTERPORT 64K ULTRA-HD MASTER STUDIO ENGINE (v8.0)
   - 4 Industrial Robotic Dummy Systems
   - 2/3 Height 3D Main Player + Bottom 4-Product Tray
   - Permanent 3D Floating Capsules with Thumbnails & English Titles
   - Right Unified Sidebar (Radar Minimap + Focused Robot Specs)
   - Product Inspection Drawer: 4K Photo & Interactive 360° 3D Mini Player
...
// 2. FOUR DISTINCT INDUSTRIAL ROBOT PRODUCTS
const PRODUCTS_DATA = [
  {
    id: 'PROD-01-COBOT',
    name: 'Apex Cobot X16',
  ...
  },
  {
    ...
    worldPos: new THREE.Vector3(190, -40, -320),
    nodeIdx: 0,
  ...
  },
  {
    ...
    worldPos: new THREE.Vector3(-140, 20, -350),
    nodeIdx: 1,
...
// 10. PRODUCT INSPECTION DRAWER (WITH HIGH-RES HERO IMAGE & 360° 3D MINI PLAYER)
...
function buildProceduralRobotModel(type) {
  ...
  if (type === 'cobot') {
    ...
    // 3 pairs of parallel carbon fiber struts
    for (let i = 0; i < 3; i++) {
    ...
    // Z-Axis vertical ball screw & micro tool
...
function openProductDrawer(idx) {
  ...
  // Update 3D model if already in 3D mode
...
function toggleAutoTour() {
  ...
  if (autoTourActive) {
    ...
    showToast('▶ 5s Interval Automated 360° Studio Tour Started');
...
function downloadAllPhotos() {
  ...
  showToast('📥 64K Master Ultra-HD photos download started.');
}
...
console.log('Written demo-matterport.html v8.0 with 4 Robot Products & Mini 3D Player! Size:', fs.statSync(outPath).size);
