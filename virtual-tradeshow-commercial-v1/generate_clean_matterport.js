// generate_clean_matterport.js — TRUE 360° Ultra-HD 8K Matterport Virtual Tour v5.4
const fs = require('fs');
...
<script>
/* ═══════════════════════════════════════════════════════════
   MATTERPORT 3D SPATIAL DIGITAL TWIN ENGINE  v5.4
...
console.log('Written demo-matterport.html v5.4! Size:', fs.statSync(outPath).size);
