// generate_clean_matterport.js — Matterport 16K/8K Ultra-HD 360° Studio with Product Floating Details & Mobile Landscape (v6.4)
const fs = require('fs');
...
<script>
/* ═══════════════════════════════════════════════════════════
   MATTERPORT 16K ULTRA-HD 360° STUDIO ENGINE (v6.4)
...
// 1. SPATIAL NODES (3 Vantage Points)
const SPATIAL_NODES = [
  {
    id: 0,
...
// 6. HIGH-RESOLUTION TEXTURE LOADER WITH GPU ADAPTATION
...
console.log('Written demo-matterport.html v6.4 Studio! Size:', fs.statSync(outPath).size);
