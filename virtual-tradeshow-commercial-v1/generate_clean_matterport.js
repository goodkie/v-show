...
<title>DN'a ROBOTIC | Photo Immersive Booth — Reference Master</title>
...
<div id="app-layout">
  ...
  <header id="topbar">
    <div class="brand-group">
      ...
      <div class="brand-badge"><div class="pulse-dot"></div> PHOTO IMMERSIVE BOOTH</div>
    </div>
    <div class="top-actions">
      ...
      <button class="btn-ui download" onclick="openDownloadModal()">DOWNLOAD BROCHURE</button>
  ...
  <div id="portrait-tip-bar" onclick="this.style.display='none'">
    📱 Rotate your phone to <strong>[Landscape Mode]</strong> for the optimal ultra-wide studio experience!
  ...
  <main id="studio-workspace">
    ...
    <section id="player-workspace">
      <div id="viewer-container">
        ...
        <div class="player-tag">🌐 Photo Immersive 360° Studio</div>
        <div class="res-pill" id="res-indicator">ULTRA-HD MASTER STUDIO</div>
      </div>
...
function initThree() {
  ...
  if (resPill) {
    resPill.textContent = 'ULTRA-HD MASTER STUDIO';
  }
