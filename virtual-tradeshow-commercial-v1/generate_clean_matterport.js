// generate_clean_matterport.js — Matterport 64K Master Ultra-HD 360° Studio (No People, Original Full Player Size, v6.8)
const fs = require('fs');
...
.drawer {
  ...
  width: 440px; max-width: 90vw; background: rgba(7, 14, 26, 0.98);
...
.drawer-hero {
  ...
  padding: 15px; margin: 8px 0 14px; display: flex; flex-direction: column; gap: 6px;
}
...
<script>
/* ═══════════════════════════════════════════════════════════
   MATTERPORT 64K ULTRA-HD MASTER STUDIO ENGINE (v6.8)
...
// 2. PRODUCTS & 3D FLOATING HOTSPOTS (Calibrated to 64K Scene)
const PRODUCTS_DATA = [
  {
    id: 'PROD-01-COBOT',
    name: 'Apex Cobot X16',
...
console.log('Written demo-matterport.html v6.8 Master 64K Studio! Size:', fs.statSync(outPath).size);
