...
<div id="app-layout">
  ...
  <header id="topbar">
    <div class="brand-group">
      ...
      <div class="brand-badge"><div class="pulse-dot"></div> 64K ULTRA-HD IMMERSIVE STUDIO</div>
    </div>
    <div class="top-actions">
      ...
      <button class="btn-ui download" onclick="openDownloadModal()">DOWNLOAD 64K</button>
