...
- **전체 판정 (Overall Determination)**: **`FIRST_REAL_CUSTOMER_PRE_ACTIVATION_READY`** / **`NO-GO FOR LIVE BILLING`**
- **시스템 상태 (System Status)**: **`PHASE_10_7_PRE_ACTIVATION_COMPLETE`**
...
- **1호 실고객 온보딩 마법사**: **`READY (5-Step Wizard in Grand Control)`**
