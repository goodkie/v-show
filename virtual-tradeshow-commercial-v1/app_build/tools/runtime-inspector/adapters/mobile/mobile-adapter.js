...
class MobileAdapter {
  ...
  getGuidedCaptureDiagnostics() {
    ...
    return {
      ...
      MOBILE_RI_AUTHORIZED: Boolean(typeof window !== 'undefined' && (window.__IS_INTERNAL_QA__ || (window.sessionStorage && window.sessionStorage.getItem('mobile_ri_qa_token')))),
      ...
      QA_SESSION_ACTIVE: Boolean(typeof window !== 'undefined' && (window.__IS_INTERNAL_QA__ || (window.sessionStorage && window.sessionStorage.getItem('mobile_ri_qa_token')))),
